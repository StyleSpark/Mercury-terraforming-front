...
const agent = ref({
  ...
  area: '강남구 청담동',
  temperature: 37.5,
  intro: '<p>청담동과 강남 지역 부동산 시장을 누구보다 잘 이해하고 있습니다.<br> 연락 가능 시간 : 9시 ~ 23시<br> 평균 응답 시간 : 10분 이내 세금계산서 발행 불가</p>',
  ...
  <v-container fluid class="py-8">
    ...
    <v-row justify="center" class="mb-2">
      <v-col cols="12" md="8" class="text-center">
        ...
        <p v-html="agent.intro" class="text-body-2 mt-4"></p>
      </v-col>
    </v-row>
    ...
    <v-container>
      ...
      <!-- tab을 사용하되 스크롤 이동으로 대체를 하는게 어떤가 싶음 -->
